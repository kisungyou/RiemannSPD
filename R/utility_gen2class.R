...
#' 
#' @param p dimensionality for SPD matrices.
#' @param n1 the number of type 1 SPD matrices.
#' @param n2 the number of type 2 SPD matrices.
#' 
...
#' @concept utility
#' @export
spd.gen2class <- function(p=5, n1=10, n2=10){
  #------------------------------------------
  # PREP
  my_p  = max(2, round(p))
  ...
  # FIN
  # wrap
  stack_spd = structure(list(data=stack_covs, size=c(my_p,my_p)), class="spd")
